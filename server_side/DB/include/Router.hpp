...
//     bool addHandler(const std::string& method, const Handler& handler) override { return false; };
...
//     bool sendToAllProjectUsers(const Reply& reply, const ConnectionPtr& userConnection) override { return false; };
//     bool sendToUser(const Reply& reply, const ConnectionPtr& userConnection) override { return false; };
