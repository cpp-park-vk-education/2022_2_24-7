...
class Searcher : public ISearchForPlace {
   public:
    AnswerForInsertAction whatPositionDelete(Element* elementToDelete, Element* beggining,
                                             StartOfLine* lines) override;
    AnswerForInsertAction whatPosition(Element* beforeInsert, Element* insertElement, Element* afterElement,
                                       StartOfLine* line) override;
    ...
    AnswerForLineAndElementVisible searchForLineAndPos(Element* start, Element* compareElement,
                                                       StartOfLine* line,
